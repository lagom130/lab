...
file_context = '政府办事的目录及对应的资源相关申请单'
env = '326'
# env = 'DEV'
# env = 'PROD'
receivers = None
...
if __name__ == '__main__':
    ...
    info_resources = get_mysql_res("select id, info_resource_name, info_resource_provider, task_name from cmp_catalog.info_resource_platform where use_scene = '05'")
    info_res_ids = []
    info_res_dict = dict()
